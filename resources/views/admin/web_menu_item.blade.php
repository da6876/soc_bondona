...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr">
  <head>
    <meta charset="utf-8" />
    <title>Bondona | Web Menu Item</title>
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="navbar-ex-3">
                        <div class="navbar-nav me-auto">
                          <a class="nav-item nav-link active" href="javascript:void(0)">SETUP OR CONFIG / <strong> Menu Item</strong></a>
                        </div>
  
                        <form onsubmit="return false">
                          <button class="btn btn-outline-success" onclick="showModal()" type="button">Add Menu Item</button>
                        </form>
                      </div>
                    </div>
                  </nav>
                  ...
                  <div class="card">
                    <h5 class="card-header">Menu Item Info</h5>
                ...
                <form id="userInfoDataAdd" action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-2">
                        <div class="col mb-1">
                          ...
                          <input type="text" id="Other" name="Other" class="form-control" placeholder="Other" />
                        </div>
    ...
    <div class="buy-now">
        <a href="#" onclick="showModal()" class="btn btn-success btn-buy-now">Add Menu Item</a>
    </div>
    ...
    <script>
      ...
      var table1 = $('#userInfo-dataTabel').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('all.MenuItem') !!}',
        columns: [
            {data: 'menu_item_id', name: 'menu_item_id'},
            {data: 'Name', name: 'Name'},
            {data: 'Link', name: 'Link'},
    ...
    function showUserInfoData(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#menu_item_id').val(data[0].menu_item_id);
