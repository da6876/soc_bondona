...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr">
  <head>
    <meta charset="utf-8" />
    <title>Bondona | Product Category</title>
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="navbar-ex-3">
                        <div class="navbar-nav me-auto">
                          <a class="nav-item nav-link active" href="javascript:void(0)">SETUP OR CONFIG / <strong> Product Category</strong></a>
                        </div>
  
                        <form onsubmit="return false">
                          <button class="btn btn-outline-success" onclick="showModal()" type="button">Add Product Category</button>
                        </form>
                      </div>
                    </div>
                  </nav>
                  ...
                  <div class="card">
                    <h5 class="card-header">Product Category Info</h5>
                ...
                <form id="userInfoDataAdd" action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-2">
                        <div class="col mb-1">
                          ...
                          <label for="FullName" class="form-label">Product Category Name</label>
    ...
    <div class="buy-now">
        <a href="#" onclick="showModal()" class="btn btn-success btn-buy-now">Add Product Category</a>
    </div>
    ...
    function showUserInfoData(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#ProductCategoryId').val(data[0].ProductCategoryId);
