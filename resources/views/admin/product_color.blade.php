...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr">
  <head>
    <meta charset="utf-8" />
    <title>Bondona | Product Color</title>
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="navbar-ex-3">
                        <div class="navbar-nav me-auto">
                          <a class="nav-item nav-link active" href="javascript:void(0)">SETUP OR CONFIG / <strong> Product Color</strong></a>
                        </div>
  
                        <form onsubmit="return false">
                          <button class="btn btn-outline-success" onclick="showModal()" type="button">Add Product Color</button>
                        </form>
                      </div>
                    </div>
                  </nav>
                  ...
                  <div class="card">
                    <h5 class="card-header">Product Color</h5>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="userInfoDataAdd" action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-2">
                        <div class="col mb-1">
                          <input type="hidden" id="ProductColorId" name="ProductColorId"/>
                          <label for="FullName" class="form-label">Product Color Name</label>
    ...
    <div class="buy-now">
        <a href="#" onclick="showModal()" class="btn btn-success btn-buy-now">Add Product Color</a>
    </div>
    ...
    <script>
      ...
      var table1 = $('#userInfo-dataTabel').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('all.Color') !!}',
        columns: [
            {data: 'ProductColorId', name: 'ProductColorId'},
            {data: 'Name', name: 'Name'},
    ...
    function showUserInfoData(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#ProductColorId').val(data[0].ProductColorId);
