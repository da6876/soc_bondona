...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr">
  <head>
    <meta charset="utf-8" />
    <title>Bondona | Product Size</title>
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="navbar-ex-3">
                        <div class="navbar-nav me-auto">
                          <a class="nav-item nav-link active" href="javascript:void(0)">SETUP OR CONFIG / <strong> Product Size</strong></a>
                        </div>
  
                        <form onsubmit="return false">
                          <button class="btn btn-outline-success" onclick="showModal()" type="button">Add Product Size</button>
                        </form>
                      </div>
                    </div>
                  </nav>
                  ...
                  <div class="card">
                    <h5 class="card-header">Product Size</h5>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="userInfoDataAdd" action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col mb-1">
                          <input type="hidden" id="ProductSizeId" name="ProductSizeId"/>
                          <label for="FullName" class="form-label">Size Name</label>
    ...
    <div class="buy-now">
        <a href="#" onclick="showModal()" class="btn btn-success btn-buy-now">Add Product Size</a>
    </div>
    ...
    <script>
        ...
        url = "{{ url('ShowProductType') }}";
        $.ajax({
            url: url,
            type: 'POST',
            data: {'ViewType': 'ProductType', "_token": csrf_tokens},
            datatype: 'JSON',
      ...
      var table1 = $('#userInfo-dataTabel').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('all.ProductSize') !!}',
        columns: [
            {data: 'ProductSizeId', name: 'ProductSizeId'},
            {data: 'Name', name: 'Name'},
    ...
    function showUserInfoData(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#ProductSizeId').val(data[0].ProductSizeId);
                $('#Name').val(data[0].Name);
                $('#ProductType').val(data[0].ProductTypeId);
